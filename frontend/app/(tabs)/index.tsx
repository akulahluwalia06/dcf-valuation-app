...
const s = StyleSheet.create({
  ...
  title: { color: '#FFFFFF', fontSize: 36, fontWeight: '800', letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  sub: { color: '#aa7a3a', fontSize: 17, letterSpacing: 1.5, marginTop: 6, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  sectionLabel: { color: '#FF8C00', fontSize: 17, fontWeight: '700', letterSpacing: 2, marginBottom: 12, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  cardTitle: { fontSize: 17, fontWeight: '800', letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 8 },
  ...
  chipText: { fontSize: 16, fontWeight: '700', letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  // News
  ...
  newsPublisher: { color: '#FF8C00', fontSize: 16, fontWeight: '700', letterSpacing: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  newsTime: { color: '#aa7a3a', fontSize: 16, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  tickerPillText: { color: '#FF8C00', fontSize: 16, fontWeight: '700', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  newsError: { color: '#64748B', fontSize: 22, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 16, textAlign: 'center' },
  // Methodology
  ...
  recentTickerText: { color: '#FF8C00', fontWeight: '700', fontSize: 16, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  recentName: { color: '#CBD5E1', fontSize: 16, fontWeight: '600' },
  recentDate: { color: '#94A3B8', fontSize: 17, marginTop: 2 },
  recentPrice: { color: '#FF8C00', fontWeight: '700', fontSize: 22, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
