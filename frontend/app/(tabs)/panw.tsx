...
const s = StyleSheet.create({
  ...
  ticker: { color: '#FF8C00', fontSize: 36, fontWeight: '800', letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  company: { color: '#CBD5E1', fontSize: 16, letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  headerLabel: { color: '#CBD5E1', fontSize: 22, letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  headerDate: { color: '#aa7a3a', fontSize: 16, letterSpacing: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginTop: 2 },
  ...
  tabText: { color: '#CBD5E1', fontSize: 22, fontWeight: '600', letterSpacing: 0.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  intrinsicLabel: { color: '#CBD5E1', fontSize: 17, letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 6 },
  intrinsicValue: { fontSize: 52, fontWeight: '800', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', lineHeight: 60 },
  ...
  tvLabel: { color: '#CBD5E1', fontSize: 11 },
  ...
  th: { flex: 1, color: '#FF8C00', fontSize: 17, fontWeight: '700', letterSpacing: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
...
const p = StyleSheet.create({
  ...
  title: { color: '#FF8C00', fontSize: 17, fontWeight: '700', letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
});

const k = StyleSheet.create({
  card: { flex: 1, minWidth: '45%', backgroundColor: '#080808', borderWidth: 1, borderColor: '#FF8C0022', borderRadius: 10, padding: 14 },
  label: { color: '#CBD5E1', fontSize: 16, letterSpacing: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 6 },
...
const tr = StyleSheet.create({
  ...
  cell: { width: 90, paddingHorizontal: 8, paddingVertical: 8, color: '#CBD5E1', fontSize: 22, textAlign: 'right', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
...
const s2 = StyleSheet.create({
  ...
  pillText: { fontSize: 17, fontWeight: '800', letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  price: { fontSize: 36, fontWeight: '800', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
});
