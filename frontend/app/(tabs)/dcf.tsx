        ...
        <ScrollView style={s.scroll} contentContainerStyle={s.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          {activeTab === 'sensitivity' && (
            <Panel title="SENSITIVITY  —  WACC × TERMINAL GROWTH RATE">
              <Text style={{ color: '#CBD5E1', fontSize: 17, marginBottom: 12, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' }}>
...
const s = StyleSheet.create({
  ...
  headerTitle: { color: '#FFFFFF', fontSize: 30, fontWeight: '800', letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  headerSub: { color: '#aa7a3a', fontSize: 16, letterSpacing: 1, marginTop: 4, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  searchInput: { flex: 1, backgroundColor: '#050505', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 12, color: '#FF8C00', fontSize: 22, borderWidth: 1, borderColor: '#FF8C0033', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', letterSpacing: 2 },
  searchBtn: { backgroundColor: '#FF8C00', borderRadius: 8, paddingHorizontal: 20, justifyContent: 'center' },
  searchBtnText: { color: '#000', fontWeight: '800', fontSize: 16, letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  quickText: { color: '#E07000', fontWeight: '700', fontSize: 22, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  errorBox: { backgroundColor: '#1a0000', margin: 12, borderRadius: 8, padding: 14, borderWidth: 1, borderColor: '#FF3B3B44', zIndex: 1 },
  errorText: { color: '#FF3B3B', fontSize: 16, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  companyTicker: { color: '#FF8C00', fontWeight: '800', fontSize: 17, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  resetBtn: { marginLeft: 8, borderWidth: 1, borderColor: '#FF8C0044', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 6 },
  resetBtnText: { color: '#FF8C00', fontSize: 17, fontWeight: '700', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', letterSpacing: 1 },
  companyName: { color: '#CBD5E1', fontSize: 16, fontWeight: '600' },
  companySub: { color: '#CBD5E1', fontSize: 17, marginTop: 2 },
  priceLabel: { color: '#CBD5E1', fontSize: 22, letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  priceVal: { color: '#FFFFFF', fontSize: 22, fontWeight: '800', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  subTabText: { color: '#aa7a3a', fontSize: 22, fontWeight: '700', letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  subTabTextActive: { color: '#FF8C00' },
  emptyState: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 40, zIndex: 1 },
  emptyTitle: { color: '#FF8C00', fontSize: 16, fontWeight: '800', letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 12 },
  emptySub: { color: '#aa7a3a', fontSize: 22, textAlign: 'center', lineHeight: 20, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  intrinsicLabel: { color: '#CBD5E1', fontSize: 16, letterSpacing: 2, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 6 },
  intrinsicVal: { fontSize: 48, fontWeight: '800', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', lineHeight: 56 },
  ...
  methodLabel: { color: '#CBD5E1', fontSize: 22, letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 4 },
  methodVal: { color: '#CBD5E1', fontSize: 17, fontWeight: '700', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  upsideBadge: { marginTop: 14, borderWidth: 1, borderRadius: 6, paddingHorizontal: 12, paddingVertical: 6 },
  upsideText: { fontSize: 22, fontWeight: '700', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  tvLabel: { color: '#CBD5E1', fontSize: 16, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  th: { flex: 1, color: '#FF8C00', fontSize: 16, fontWeight: '700', letterSpacing: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  tableRow: { flexDirection: 'row', paddingVertical: 8, paddingHorizontal: 10 },
  td: { flex: 1, color: '#CBD5E1', fontSize: 22, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
  ...
  simpleVal: { color: '#CBD5E1', fontSize: 16, fontWeight: '600', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
});
...
const p = StyleSheet.create({
  ...
  title: { color: '#FF8C00', fontSize: 16, fontWeight: '700', letterSpacing: 1.5, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
});

const k = StyleSheet.create({
  card: { flex: 1, minWidth: '45%', backgroundColor: '#080808', borderWidth: 1, borderColor: '#FF8C0033', borderRadius: 10, padding: 12 },
  label: { color: '#CBD5E1', fontSize: 22, letterSpacing: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif', marginBottom: 4 },
  val: { color: '#FFFFFF', fontSize: 22, fontWeight: '800', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif' },
});
